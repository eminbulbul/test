  ...
  theme: {
    extend: {
      colors: {
        ...
        cardButtonPrimary: "#D72027",
        cardButtonSecondary: "#325EA9",
        cardButtonThird: "#564998",
        cardPrimaryColor: "#D9484E",
        cardSecondaryColor: "#325EA9",
        cardThirdColor: "#EDA63C",
        body: "#696969",
        heading: "#333333",
        success: {
          DEFAULT: "#4CAF50",
      ...
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
            "--prose-body": theme("colors.body"),
            "--prose-headings": theme("colors.heading"),
            iframe: {
              "margin-top": "2.5rem",
