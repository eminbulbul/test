...
const Button = ({
  ...
  // Primary Button
  const containedPrimaryClass = "bg-primary border-primary text-white";
  ...
  // Buton Sizes
  const mdBtn =
    size === "md" && "text-md px-5 py-1 min-h-[45px] md:min-h-[45px] md:px-5";
  const xsBtn = size === "xs" && "text-[13px] px-5 leading-[30px] min-h-6";
